...
curl -L --max-filesize 512000 -o /tmp/installer_OffLine.sh "https://mirror.ghproxy.com/https://raw.githubusercontent.com/darknebular/Wrapper_VideoStation/main/installer_OffLine.sh"
